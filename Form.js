...
<input type="name" name="pattren[A-Za-z]" required placeholder="Enter a valid name "></input><br></br>
 <label for="PhoneNum"><b>Phone Number</b></label><br></br>
    ...
    <input type="Address" name=" pattern=(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required placeholder="Enter a valid  address"></input><br></br><br/>
